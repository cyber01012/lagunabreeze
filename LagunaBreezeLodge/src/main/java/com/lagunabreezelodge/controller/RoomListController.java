...
public class RoomListController {
    ...
    private List<Room> getFiveStarRooms() {
        List<Room> rooms = new ArrayList<>();
        rooms.add(new Room(501, "Luxury Sea View Room", "5-Star", new BigDecimal("450.00"), "Panoramic ocean view, infinity bath, butler service", "suite10.jpg", 2));
    ...
    private VBox createCategorySection(List<Room> rooms, List<String> features) {
        ...
        categoryBox.setStyle("-fx-background-color: #e6c8a0; -fx-border-color: #ddd; -fx-border-radius: 10; -fx-padding: 15;");
    ...
    private HBox createRoomBox(Room room) {
        ...
        roomBox.setStyle("-fx-background-color:#e6c8a0; -fx-border-color: #ddd; -fx-padding: 10;");
